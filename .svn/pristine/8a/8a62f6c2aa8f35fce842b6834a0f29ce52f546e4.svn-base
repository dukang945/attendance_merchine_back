  ...
  <div class="contain-box">
    ...
    <div class="table-box">
      ...
      >
        ...
        ></el-table-column>
        <el-table-column
          prop="am_clock_in_time"
          label="上班时间"
          align="center"
          show-overflow-tooltip
        ></el-table-column>
        <el-table-column
          prop="pm_clock_in_time"
          label="下班时间"
          align="center"
        ></el-table-column>
        <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <span v-if="scope.row.status==1" style="color:res">异常</span>
        </template>
        </el-table-column>
      </el-table>
      <el-dialog
...
export default {
  ...
  methods: {
    ...
    getUserList(page, rows) {
      this.$axios
        .get("/checking-in/clockInData/getPage", { params: this.formLabelSearch })
        .then(res => {
          if (res.status == 200) {
            console.log(res);
